...
short_description: Manage NPM hosted repositories
"""
...
def main():
    ...
    argument_spec.update(
        {
            "format": {"type": "str", "choices": ["npm"], "required": False},
            ...
            "docker": {
                ...
                "options": {
                    ...
                    "http_port": {"type": "int", "default": 8082},  # Adding httpPort
                    "https_port": {"type": "int", "default": 8083},  # Adding httpsPort
                    "subdomain": {
                        "type": "str",
                        "default": "docker-a",
                    },  # Adding subdomain
