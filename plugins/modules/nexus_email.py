...
def update_email_setting(helper, existing_data):
    ...
    data = {
        ...
        "sslServerIdentityCheckEnabled": helper.module.params["ssl_server_identity_check_enabled"],
    ...
    if changed is False and helper.module.params["authentication"]["password"] is None:
        return existing_data, False
...
def main():
    ...
    argument_spec.update(
        ...
        authentication={"type": "dict", "default": {}, "options":{
        ...
        ssl_server_identity_check_enabled={"type": "bool", "required": False, "default": False},
